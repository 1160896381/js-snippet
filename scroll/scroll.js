...
function ss(wrapper, type, arrow) {
    var buttons_group;
    var botton_gg = wrapper.find(".player-slider-scroll");

    var handle_c = wrapper.find(".player-slider-scroll-btn"); //滑动手柄
    var handle_par = wrapper.find(".player-slider-scroll-border"); //滑动槽
    var move_content = wrapper.find(".player-time-ruler-container"); //滑动的主体内容
    var clude_con = wrapper.find(".player-time-ruler"); //主体内容的父级
    var arrow_btn = wrapper.find(".player-slider-scroll").children("span"); //左右箭头
    var pw, ph;
    var is_move = 1;
    ...
    //点击左右箭头的事件
    //var arrow_btn=$(".player-slider-scroll span");
    var span_m = 10;
    var timer;
